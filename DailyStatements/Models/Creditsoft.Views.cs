...
[assembly: DbMappingViewCacheTypeAttribute(
    typeof(AMPStatements.Models.Entities),
    typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySetsde408d1d1989c34319e552c93e69dc28886d18c625da8b79914cc1ec77f87d71))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    internal sealed class ViewsForBaseEntitySetsde408d1d1989c34319e552c93e69dc28886d18c625da8b79914cc1ec77f87d71 : DbMappingViewCache
    {
        /// <summary>
        ...
        {
            get { return "de408d1d1989c34319e552c93e69dc28886d18c625da8b79914cc1ec77f87d71"; }
        }
        ...
        public override DbMappingView GetView(EntitySetBase extent)
        {
            ...
            if (extentName == "CreditsoftStoreContainer.Custom_DailyStatementsPrintLog")
            {
                return GetView32();
            }

            if (extentName == "Entities.Custom_DailyStatementsPrintLog")
            {
                return GetView33();
            }
    ...
    SELECT VALUE -- Constructing ACHGroups
        [Creditsoft.Store.ACHGroups](T1.ACHGroups_ACHGroupID, T1.ACHGroups_PaymentDueDate, T1.ACHGroups_Period, T1.ACHGroups_DraftDay, T1.[ACHGroups.upsize_ts], T1.ACHGroups_BankAccountID, T1.ACHGroups_WeekDay, T1.ACHGroups_Show, T1.ACHGroups_CreditCardBankAccountID)
    FROM (
        SELECT 
            ...
            T.CreditCardBankAccountID AS ACHGroups_CreditCardBankAccountID, 
            True AS _from0
    ...
    FROM (
        SELECT 
            ...
            T.CSPTier1 AS ClientCred_CSPTier1, 
            T.CSPTier2 AS ClientCred_CSPTier2, 
            T.CSPTier3 AS ClientCred_CSPTier3, 
            True AS _from0
    ...
    FROM (
        SELECT 
            ...
            T.UseCC AS Clients_UseCC, 
            T.SignNow_UserID AS [Clients.SignNow_UserID], 
            T.SignNow_AccessToken AS [Clients.SignNow_AccessToken], 
            T.MD_Qualifier AS [Clients.MD_Qualifier], 
            T.ContractMonthlyFee AS Clients_ContractMonthlyFee, 
            T.MD_PolicyGroup AS [Clients.MD_PolicyGroup], 
            T.MD_TypeInjuryQualifier AS [Clients.MD_TypeInjuryQualifier], 
            T.MD_DateOfInjury AS [Clients.MD_DateOfInjury], 
            T.CreditListed AS Clients_CreditListed, 
            T.CreditListedDate AS Clients_CreditListedDate, 
            T.CreditListedFirstDelinquencyDate AS Clients_CreditListedFirstDelinquencyDate, 
            T.MD_FamilyPlan AS [Clients.MD_FamilyPlan], 
            True AS _from0
    ...
    FROM (
        SELECT 
            ...
            T.SignNow_UserID AS [CoApps.SignNow_UserID], 
            T.SignNow_AccessToken AS [CoApps.SignNow_AccessToken], 
            T.MD_PolicyGroup AS [CoApps.MD_PolicyGroup], 
            True AS _from0
    ...
    FROM (
        SELECT 
            ...
            T.AllowCSPTier1 AS Creditors_AllowCSPTier1, 
            T.AllowCSPTier2 AS Creditors_AllowCSPTier2, 
            T.AllowCSPTier3 AS Creditors_AllowCSPTier3, 
            True AS _from0
    ...
    SELECT VALUE -- Constructing Locations
        [Creditsoft.Store.Locations](T1.Locations_LocationID, T1.Locations_LocationName, T1.Locations_BackColor, T1.Locations_ForeColor, T1.Locations_LocationAddress1, T1.Locations_LocationAddress2, T1.Locations_LocationCity, T1.Locations_LocationState, T1.Locations_LocationZip, T1.Locations_LocationPhone, T1.Locations_LocationFax, T1.Locations_Division, T1.[Locations.upsize_ts], T1.Locations_DialingRuleSetID, T1.Locations_UserDefinedCode, T1.Locations_MarketingCompanyName, T1.Locations_Website, T1.Locations_APIAffiliateID, T1.Locations_APIFeesGroup, T1.Locations_Product, T1.Locations_Notes, T1.Locations_QBCompanyID)
    FROM (
        SELECT 
            ...
            T.QBCompanyID AS Locations_QBCompanyID, 
            True AS _from0
    ...
    FROM (
        SELECT 
            ...
            T.CCBatchID AS Receipts_CCBatchID, 
            T.CCBatchDetailsID AS Receipts_CCBatchDetailsID, 
            True AS _from0
    ...
    FROM (
        ...
        private static DbMappingView GetView20()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing ACHGroups
        [Creditsoft.ACHGroups](T1.ACHGroups_ACHGroupID, T1.ACHGroups_PaymentDueDate, T1.ACHGroups_Period, T1.ACHGroups_DraftDay, T1.[ACHGroups.upsize_ts], T1.ACHGroups_BankAccountID, T1.ACHGroups_WeekDay, T1.ACHGroups_Show, T1.ACHGroups_CreditCardBankAccountID)
    FROM (
        SELECT 
            T.ACHGroupID AS ACHGroups_ACHGroupID, 
            T.PaymentDueDate AS ACHGroups_PaymentDueDate, 
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for CreditsoftStoreContainer.Custom_DailyStatementsPrintLog.
        /// </summary>
        /// <returns>The mapping view.</returns>
        private static DbMappingView GetView32()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing Custom_DailyStatementsPrintLog
        [Creditsoft.Store.Custom_DailyStatementsPrintLog](T1.[Custom_DailyStatementsPrintLog.ID], T1.[Custom_DailyStatementsPrintLog.ACHBatchID], T1.[Custom_DailyStatementsPrintLog.DatePrinted], T1.[Custom_DailyStatementsPrintLog.PrintedBy], T1.[Custom_DailyStatementsPrintLog.Success])
    FROM (
        SELECT 
            T.ID AS [Custom_DailyStatementsPrintLog.ID], 
            T.ACHBatchID AS [Custom_DailyStatementsPrintLog.ACHBatchID], 
            T.DatePrinted AS [Custom_DailyStatementsPrintLog.DatePrinted], 
            T.PrintedBy AS [Custom_DailyStatementsPrintLog.PrintedBy], 
            T.Success AS [Custom_DailyStatementsPrintLog.Success], 
            True AS _from0
        FROM Entities.Custom_DailyStatementsPrintLog AS T
    ) AS T1");
        }

        /// <summary>
        /// Gets the view for Entities.Custom_DailyStatementsPrintLog.
        /// </summary>
        /// <returns>The mapping view.</returns>
        private static DbMappingView GetView33()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing Custom_DailyStatementsPrintLog
        [Creditsoft.Custom_DailyStatementsPrintLog](T1.[Custom_DailyStatementsPrintLog.ID], T1.[Custom_DailyStatementsPrintLog.ACHBatchID], T1.[Custom_DailyStatementsPrintLog.DatePrinted], T1.[Custom_DailyStatementsPrintLog.PrintedBy], T1.[Custom_DailyStatementsPrintLog.Success])
    FROM (
        SELECT 
            T.ID AS [Custom_DailyStatementsPrintLog.ID], 
            T.ACHBatchID AS [Custom_DailyStatementsPrintLog.ACHBatchID], 
            ...
            T.Success AS [Custom_DailyStatementsPrintLog.Success], 
            True AS _from0
        FROM CreditsoftStoreContainer.Custom_DailyStatementsPrintLog AS T
    ) AS T1");
        }
    }
}
